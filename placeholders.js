...
(function () {
  ...
  const THEMES = {
    blue:   { tier: '#5a86b8', tier2: '#7fa8d4' }, // Mountains / Section B
    green:  { tier: '#6a9c6a', tier2: '#8fc48f' }, // Section C
    yellow: { tier: '#b8a858', tier2: '#d4c47f' }  // Section D
  };
  ...
  function inject() {
    ...
    if (mount) {
      ...
      buildCardSection(mount, 'Example Section D', 8, 'D', THEMES.yellow);
    }
