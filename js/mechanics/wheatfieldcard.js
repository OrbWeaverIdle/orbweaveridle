...
(function () {
  ...
  // Called by mountains.js when the Wheat Field build completes, so the
  // player starts with a full wheat pool rather than waiting for growth.
  window.OrbWeaver.WheatField = { fillWheat: () => { wheat = CAP; } };
})();
