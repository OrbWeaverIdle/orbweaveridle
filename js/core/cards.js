...
(function () {
  ...
  function makeStepperSet(mechanic, isModal) {
    ...
    wrap.querySelector('.stepper-plus').addEventListener('click', () => window.OrbWeaver.Workers.assign(mechanic.id));
    wrap.querySelector('.stepper-minus').addEventListener('click', () => window.OrbWeaver.Workers.unassign(mechanic.id));
    return wrap;
  }
