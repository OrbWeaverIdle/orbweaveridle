...
(function () {
  ...
  document.addEventListener('pointerdown', (e) => {
    ...
    if (action === 'start') track.start(item);
    else if (action === 'cancel') track.cancel(item);
    else if (action === 'reveal' && track.revealWithGold) track.revealWithGold(item);
    else if (action === 'toggle-collapse' && track.toggleCollapse) track.toggleCollapse();
